...
"     Custom javascript indent by Andrew Radev July 31, 2010
...
if exists('*javascript#GetIndent')
  let b:custom_javascript_indent = function('javascript#GetIndent')
endif
...
fun! HtmlIndentGet(lnum)
  ...
  " [-- special handling for <javascript>: use custom indent or cindent --]
...
"      if exists('b:custom_javascript_indent')
"        return b:custom_javascript_indent()
"      else
"        return cindent(a:lnum)
"      endif
    endif
