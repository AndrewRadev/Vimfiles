" A custom variant of Boyko Bantchev's phonetic keymap with only the
" single-letter mappings. Any two- or more-letter combinations require an
" annoying wait in my setup and, in my case, are not that critical

scriptencoding utf-8

let b:keymap_name = "custom_pho"
