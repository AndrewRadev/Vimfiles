...
hi Normal       cterm=none    ctermfg=255   guibg=#080808 guifg=#ffffff
...
hi LineNr       cterm=none    ctermfg=228   guifg=#ffff87
...
hi Special      cterm=none    ctermfg=206   guifg=#ff5fd7
hi Statement    cterm=none    ctermfg=171   gui=none      guifg=#d75fff
hi String       cterm=none    ctermfg=180   guifg=#d7af87
